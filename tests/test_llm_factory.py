from autopilot_jobhunt.llm.factory import create_llm_service
from autopilot_jobhunt.llm.providers.google import GoogleAdkService
from autopilot_jobhunt.llm.providers.nvidia import NvidiaAdkService
from autopilot_jobhunt.llm.providers.ollama import OllamaAdkService
...
def test_ollama_service_uses_configured_base_url(monkeypatch):
    ...
    monkeypatch.setattr(OllamaAdkService, "_load_litellm_class", lambda self: FakeLiteLlm)
    service = OllamaAdkService({"ollama_model": "llama3.1", "ollama_base_url": "http://localhost:11434/v1"})
